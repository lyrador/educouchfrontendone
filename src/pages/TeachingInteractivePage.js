        ...
        <div style={{ backgroundColor: "#F8F9FA", width: "100%", height: "75vh", paddding: 0 }}>
            ...
            <div style={{ justifyContent: "center", display: 'flex' }}>
                <div className="container">
                    ...
                    {<div ref={ref} style={{ height: `${newTextBoxHeight}px`, width: `${currentPage.textBoxWidth}px !important`, position: 'absolute', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
