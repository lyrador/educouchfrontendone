      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route path = "/myTeachingCourse/new" element={
              <RequireAuth>
              <Appbar/>
                <TeachingCourseNew />
              </RequireAuth>
            ...
            <Route path = "/myTeachingCourse/:moduleCode/files" element={
              <RequireAuth>
              <Appbar/>
                <TeachingFileList />
              </RequireAuth>
            ...
            <Route path = "/myTeachingCourse/:moduleCode/files/:folderId" element={
              <RequireAuth>
              <Appbar/>
            ...
            <Route path = "/myTeachingCourse/:courseId/forum" element={
              <RequireAuth>
              <Appbar/>
                <TeachingForumList />
              </RequireAuth>
            ...
            <Route path = "/myTeachingCourse/:courseId/forum/:forumId" element={              
              <RequireAuth>
              <Appbar/>
                <TeachingForum />
              </RequireAuth>
            ...
            <Route path = "/myTeachingCourse/:courseId/forum/:forumId/:discussionId" element={
              <RequireAuth>
              <Appbar/>
                <TeachingDiscussion/>
              </RequireAuth>
            ...
            <Route path = "/adminDrawer" element={
              <RequireAuth>
              <Appbar/>
                <SettingsDrawer />
              </RequireAuth>
