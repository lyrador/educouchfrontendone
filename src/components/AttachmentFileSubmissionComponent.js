...
function AttachmentFileSubmissionComponent({
  attachment,
  courseId,
  ...
  var fileSubmissionId = useParams();
  fileSubmissionId = fileSubmissionId.assessmentId;
  ...
  const processRename = (e) => {
    ...
    var apiUrl =
      "http://localhost:8080/renameAttachment?attachmentId=" +
  ...
  const processDeletion = () => {
    fetch(
      "http://localhost:8080/deleteFileSubmissionAttachment?attachmentId=" +
        attachment.attachmentId +
        "&fileSubmissionId=" +
        fileSubmissionId,
      {
    ...
    <List>
      ...
      <ListItem>
        ...
        >
          ...
          <ListItemText primary={attachment.fileOriginalName} />
        ...
        <Dialog
          open={renameDialogBox}
          onClose={closeRenameDialogBox}
          fullWidth="lg"
        >
          <DialogContent>
            <DialogContentText>Rename attachment</DialogContentText>
...
export default AttachmentFileSubmissionComponent;
